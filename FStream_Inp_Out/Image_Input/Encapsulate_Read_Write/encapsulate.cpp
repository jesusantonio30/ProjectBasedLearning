...
int main() {
    ...
    std::string binary_file = "ex_img.webp";
    std::string copy_binary = "copy_" + binary_file;

    std::vector<char> data = readBinaryFile(binary_file);

    writeBinaryFile(copy_binary, data);
